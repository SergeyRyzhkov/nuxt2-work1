<template>
<section class="flex items-center social-items">
  <a :href="item.url" target="_blank" class="social-item flex items-center justify-center" v-for="(item, i) in socials" :key="i">
    <figure>
